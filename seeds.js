...
var secretData =[
	...
	},
	{
		...
		body: "The age old, whos more clutch debate. Let me preface this with, I don't believe clutch is as important as other people believe. Not to say when KD drained that quote on quote clutch 3 in LBJ's face, I didn't cheer my face off. What I am getting at is, clutch has a lot timing to it. When KD drained that 3, at 40% shooter from the arc, he wouldve made that same shot around 40% of the time. This is being lazy and ignoring LBJ jumping at him. Basically, this shot became clutch because the moment of time it was made. Anyways, let's just assume clutch is all its said to be. Statiscally, MJ and LBJ are identical in clutchness. In terms of go-ahead shots in the Final 5 seconds of playoff, MJ has 3 buzzer beaters and 5 for 11 overall (45%) vs LBJ 4 buzzer beater 6 for 13 (46%) Essentially, if you want to go clutch, LBJ has technically been 1% more more clutch on 2 more shots. Lastly, people say LBJ passes it during crunch time, aka the Ray Allen savior 3. Which he techincally did'nt pass it. He tried to take that 3 to send it to OT. People forget it was LBJ's 15 fourth Q points back into. Also LBJ's playstyle is play making. If statiscally he makes a shot 32% rate from 3 and you have a wide open Ray Allen at 41%, why wouldn't you pass it? People say oh MJ would've taken it. I don't understand how this is an agrument of whos better, it's based on strength. LBJ in his prime had an unstoppable drive which caused the lanes to be clogged, allowing wide open 3s. Knocking one of the best aspects of LBJ's game, makes no sense.",
		body2: "In conculsion: MJ is more clutch than LBJ is a lie. They are both relatively the same clutchness."
	},
	{
		title: "BUT THE ERAS",
		image: "http://nbahoopsonline.com/teams/ChicagoBulls/History/Championships/91bulls.jpg",
		body: "The difference of eras is something statistics will never be able to show. Some of the main things people use with the Jordan Era is the toughness and hand checking. I think it is blasphemous that people think that a 250lb, 6'8, freight train of a man in LBJ would not be tough enough to drive into much smaller defenders? This current generation of medicine and technology has produced athletes that the world has never seen. There's a reason that you constantly see people beat records for 40 yard dash in NFL, swimming records, and so on. These are all athletic accolades. On to hand checking. LBJ was a lockdown defender in his prime before all the mileage wore him down. Hand checking works both ways because this allows LBJ to handcheck people as well. I can't even imagine someone like Kawhi with hand checking. Still not convinced? I just watched Zion Williamson debut yesterday. Dude is a freak of nature, 6'7 285lbs with a 45in vertical. This is almost the same bounce as MJ with 70 more lbs. I'm not saying Zion is better than MJ but just examining the phyiscal specimens that exist nowadays.",
